...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "appSchema exposes the source image upload control",
    browser: true,
    browserTestName: "image card browser: upload clear rotate flip and reset source image",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "Uploading an image creates a runtime media asset and the card renderer/export consumes mediaAssets[] transform metadata; clear/remove empties the source image, rotate and flip change the rendered output, and Reset controls removes uploaded source media when no default exists.",
    fixture:
      "Use a non-square image fixture so cover/crop, 90 degree rotate, Flip H, Flip V, clear, and reset visibly change the card output.",
    id: "source.image",
    kind: "control",
    target: "source.image",
    userAction:
  ...
  },
  {
    ...
    expectedObservable:
      "Dragging Radius changes the preview card border radius during the drag and the rendered corner pixels change.",
    fixture: "Set Radius to 0px and 96px on the default card.",
    id: "card.radius",
    kind: "control",
    target: "card.radius",
    userAction: "Drag the Radius slider thumb from the default value to both extremes.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps depth to card style",
    browser: true,
    browserTestName: "image card browser: depth slider changes product lift live",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
    ...
    kind: "control",
    target: "card.shadow",
    userAction: "Drag the Depth slider thumb from minimum to maximum.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps image scale to product transform",
    browser: true,
    browserTestName: "image card browser: image scale slider zooms uploaded image live",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "With an uploaded image, dragging Scale changes the source image transform during the drag and visibly zooms the image crop.",
    fixture: "Upload a landscape image, then set Scale from 0.6 to 2.",
    id: "image.scale",
    kind: "control",
    target: "image.scale",
    userAction: "Upload an image and drag the Scale slider.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps image position vector to product transform",
    browser: true,
    browserTestName: "image card browser: image position vector moves uploaded image",
    componentType: "vector",
    controlPartCoverage: ["vector.x", "vector.y"],
    evidence: "rendered-pixels",
    expectedObservable:
      "With an uploaded image, changing X moves the crop horizontally and changing Y moves the crop vertically.",
    fixture: "Upload a non-centered image with visible edge contrast.",
    id: "image.position",
    kind: "control",
    target: "image.position",
    userAction: "Drag the Position vector pad on both axes and double-click it to reset.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps title text to product output",
    browser: true,
    browserTestName: "image card browser: title text updates canvas title",
    componentType: "text",
    evidence: "product-output",
    expectedObservable:
      "Typing in Title changes the data-product-title text in the preview and exported PNG text content source.",
    fixture: "Replace Weekend Market with Summer Launch.",
    id: "title.text",
    kind: "control",
    target: "title.text",
    userAction: "Type a new title into the Title field.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps title fontPicker to product output",
    browser: true,
    browserTestName: "image card browser: title style changes size color weight and spacing",
    componentType: "fontPicker",
    controlPartCoverage: "all-visible-parts",
    evidence: "product-output",
    expectedObservable:
      "Changing title fontId, fontWeight, fontSize, letterSpacing, lineHeight, textCase, color, and opacity changes the rendered title style.",
    fixture: "Use a short title so size, color, case, opacity, and spacing changes are visible.",
    id: "title.style",
    kind: "control",
    target: "title.style",
    userAction: "Edit every visible Title Style fontPicker part.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps title stroke toggle to text outline",
    browser: true,
    browserTestName: "image card browser: title stroke toggle shows outline",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Turning on Title Stroke Enable shows an outline around the title in preview and PNG export.",
    fixture: "Use a large short title with a dark stroke color.",
    id: "title.stroke.enabled",
    kind: "control",
    target: "title.stroke.enabled",
    userAction: "Toggle Title Stroke Enable on and off.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps title stroke color to text outline",
    browser: true,
    browserTestName: "image card browser: title stroke color changes outline",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Title Stroke Color changes the title outline color while preserving the fill color.",
    fixture: "Enable title stroke and switch between black and yellow stroke colors.",
    id: "title.stroke.color",
    kind: "control",
    target: "title.stroke.color",
    userAction: "Enable Title Stroke and choose a different stroke color.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps title stroke width to text outline",
    browser: true,
    browserTestName: "image card browser: title stroke width changes outline thickness",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Title Stroke Width changes the title outline thickness in preview and PNG export.",
    fixture: "Enable title stroke and set Width from 0px to 16px.",
    id: "title.stroke.width",
    kind: "control",
    target: "title.stroke.width",
    userAction: "Enable Title Stroke and drag the Width slider.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps caption text to product output",
    browser: true,
    browserTestName: "image card browser: caption text updates canvas caption",
    componentType: "text",
    evidence: "product-output",
    expectedObservable:
      "Typing in Caption changes the data-product-caption text in the preview and exported PNG text content source.",
    fixture: "Replace the default caption with a short event detail.",
    id: "caption.text",
    kind: "control",
    target: "caption.text",
    userAction: "Type a new caption into the Caption field.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps caption fontPicker to product output",
    browser: true,
    browserTestName: "image card browser: caption style changes size color weight and spacing",
    componentType: "fontPicker",
    controlPartCoverage: "all-visible-parts",
    evidence: "product-output",
    expectedObservable:
      "Changing caption fontId, fontWeight, fontSize, letterSpacing, lineHeight, textCase, color, and opacity changes the rendered caption style.",
    fixture: "Use a one-line caption so typography changes are visible.",
    id: "caption.style",
    kind: "control",
    target: "caption.style",
    userAction: "Edit every visible Caption Style fontPicker part.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps caption stroke toggle to text outline",
    browser: true,
    browserTestName: "image card browser: caption stroke toggle shows outline",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Turning on Caption Stroke Enable shows an outline around the caption in preview and PNG export.",
    fixture: "Use a short caption with a dark stroke color.",
    id: "caption.stroke.enabled",
    kind: "control",
    target: "caption.stroke.enabled",
    userAction: "Toggle Caption Stroke Enable on and off.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps caption stroke color to text outline",
    browser: true,
    browserTestName: "image card browser: caption stroke color changes outline",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Caption Stroke Color changes the caption outline color while preserving the fill color.",
    fixture: "Enable caption stroke and switch between black and yellow stroke colors.",
    id: "caption.stroke.color",
    kind: "control",
    target: "caption.stroke.color",
    userAction: "Enable Caption Stroke and choose a different stroke color.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps caption stroke width to text outline",
    browser: true,
    browserTestName: "image card browser: caption stroke width changes outline thickness",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable:
      "Dragging Caption Stroke Width changes the caption outline thickness in preview and PNG export.",
    fixture: "Enable caption stroke and set Width from 0px to 12px.",
    id: "caption.stroke.width",
    kind: "control",
    target: "caption.stroke.width",
    userAction: "Enable Caption Stroke and drag the Width slider.",
  },
  {
    automated: true,
    automatedTestName: "appSchema exposes PNG background inclusion",
    browser: true,
    browserTestName: "image card browser: include switch controls preview and PNG alpha",
    componentType: "switch",
    evidence: "exported-bytes",
    expectedObservable:
      "Turning Include off hides the live preview product background, makes PNG output transparent, and video output would keep the background if video export were added.",
    fixture: "Use a bright background color and export with Include on and off.",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction: "Toggle Include off and on, then export PNG.",
  },
  {
    automated: true,
    automatedTestName: "appSchema maps background color to preview and PNG",
    browser: true,
    browserTestName: "image card browser: background color changes preview and export",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing the Background color updates the visible card fill and the included-background PNG pixels.",
    fixture: "Switch between #111827 and #F97316 with Include on.",
    id: "appearance.background",
    kind: "control",
    target: "appearance.background",
    userAction: "Pick a new Background color.",
  },
  {
    automated: true,
    automatedTestName: "appSchema exposes image export format options",
    browser: true,
    browserTestName: "image card browser: image export format options are selectable",
    componentType: "select",
    evidence: "command-side-effect",
    expectedObservable:
      "Selecting PNG and JPG changes export.image.format in runtime state; PNG remains the baseline footer export format.",
    fixture: "Default card with Image Export section visible.",
    id: "export.image.format",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.format",
    userAction: "Open Format and select each visible option.",
  },
  {
    automated: true,
    automatedTestName: "appSchema exposes image export resolution options",
    browser: true,
    browserTestName: "image card browser: image export resolution changes PNG dimensions",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing 2K and 4K before Export PNG changes the decoded PNG long-edge pixel dimensions through createToolcraftPngExportCanvas resolution.",
    fixture: "Default 1:1 card exported at 2K and 4K.",
    id: "export.image.resolution",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.resolution",
    userAction: "Select multiple Resolution values and export PNG.",
  },
  {
    actionCoverage: ["export-png"],
    automated: true,
    automatedTestName: "appSchema exposes Export PNG footer action",
    browser: true,
    browserTestName: "image card browser: export png returns a pending action and downloads bytes",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Clicking Export PNG returns the real export Promise, shows the sticky footer progress accent, uses createToolcraftPngExportCanvas, and downloads non-empty PNG bytes.",
    fixture: "Default card plus an uploaded image.",
    id: "export.actions",
    kind: "control",
    target: "export.actions",
    userAction: "Click the Export PNG sticky footer action.",
  },
  {
    automated: true,
    automatedTestName: "appSchema persists edited image card settings",
    browser: true,
    browserTestName: "image card browser: reload restores edited values",
    componentType: "runtime",
    evidence: "persistence-state",
    expectedObservable:
      "After changing Radius and Title, a real page reload restores the persisted control values and product output.",
    fixture: "Change Radius to 12 and Title to Persisted Card before page.reload.",
    id: "runtime.persistence",
    kind: "runtime",
    persistenceCoverage: "reload",
    userAction: "Change visible settings, wait for persistence, reload the browser page, and observe restored output.",
  },
];
...
export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  ...
  {
    entity: "Source image placement",
    groupingReason:
      "Scale and position are both image transform decisions for the uploaded source inside the card.",
    targets: ["image.scale"],
    title: "Image Placement",
    workflowStage: "composition",
  },
  {
    entity: "Source image placement vector",
    groupingReason:
      "The compound vector control owns both X and Y placement axes as one spatial editor.",
  ...
  },
  {
    entity: "Title text",
    groupingReason:
      "The title content defines the top text block copy.",
    targets: ["title.text"],
    title: "Title Text",
  ...
  },
  {
    ...
    groupingReason:
      "The compound fontPicker owns title font, size, color, opacity, spacing, case, and line height together.",
    targets: ["title.style"],
    title: "Title Style",
    workflowStage: "content",
  },
  {
    entity: "Title outline",
    groupingReason:
      "The title stroke toggle, color, and width jointly define the title text outline.",
    targets: ["title.stroke.enabled", "title.stroke.color", "title.stroke.width"],
    title: "Title Stroke",
    workflowStage: "content",
  },
  {
    entity: "Caption text",
    groupingReason:
      "The caption content defines the bottom text block copy.",
    targets: ["caption.text"],
    title: "Caption Text",
    workflowStage: "content",
  },
  {
    entity: "Caption typography",
    groupingReason:
      "The compound fontPicker owns caption font, size, color, opacity, spacing, case, and line height together.",
    targets: ["caption.style"],
    title: "Caption Style",
    workflowStage: "content",
  },
  {
    entity: "Caption outline",
    groupingReason:
      "The caption stroke toggle, color, and width jointly define the caption text outline.",
    targets: ["caption.stroke.enabled", "caption.stroke.color", "caption.stroke.width"],
  ...
  },
  {
    ...
    groupingReason:
      "Background inclusion and color together control live preview fill and PNG alpha behavior.",
    targets: ["export.includeBackground", "appearance.background"],
    title: "Background",
    workflowStage: "output",
  },
  {
    entity: "PNG export settings",
    groupingReason:
      "Format and resolution configure the image export action immediately below them.",
